        ...
        <div className="mt-8 rounded-3xl bg-white/90 backdrop-blur border border-slate-200 shadow-xl p-8 sm:p-12">
          <div className="max-w-3xl">
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-3">
              ...
              <a
                href="https://katokifoundation.org"
                className="inline-flex items-center justify-center rounded-2xl border border-slate-200 bg-white px-6 py-3 text-slate-700 font-semibold hover:bg-slate-50 transition"
              >
                Main website
              </a>
            </div>
